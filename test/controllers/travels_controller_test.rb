...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post travels_url, params: { travel: { destination: @travel.destination, distance: @travel.distance, employee_id: @travel.employee_id, name: @travel.name, source: @travel.source } }
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { destination: @travel.destination, distance: @travel.distance, employee_id: @travel.employee_id, name: @travel.name, source: @travel.source } }
